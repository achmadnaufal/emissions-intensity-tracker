"""
Generate sample data for emissions-intensity-tracker.
...
COLUMNS = ["operation_id", "year", "scope1_tco2e", "scope2_tco2e", "scope3_tco2e", "production_tonnes", "intensity_tco2e_t"]
